...
aliases:
  - "The Eternal Cycle"
  - "Marathon Infinity arc"
  - "The W'rkncacnter Crisis"
scope: trilogy
summary: "The non-linear Marathon Infinity narrative: the Pfhor's trih xeem at Lh'owon, the W'rkncacnter's release, the Jjaro station, and Durandal and Tycho's final collision across looping timelines."
era: unknown
status: open
games: ["[[Marathon Infinity]]"]
spans: ["[[Marathon Infinity]]"]
principals: ["[[Durandal]]", "[[Tycho]]", "[[W'rkncacnter]]", "[[S'pht'Kr]]", "[[Pfhor]]"]
canon-status: canon
confidence: working
tags: [thread, infinity, wrkncacnter, jjaro, trilogy, brane-hub]
source-count: 20
mentioned-by: 9
appears-in: []
...
- **Yrro.** The Jjaro entity who originally imprisoned the W'rkncacnter is named "Yrro" in one terminal[^17] and appears as "yrro(farcast)" in a chip name. No other information about Yrro is in the pack. Source-silent beyond the name and the station attribution.
