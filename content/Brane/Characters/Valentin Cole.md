---
type: character
aliases: [Valentin Cole, V. Cole, Dr. Val Cole, Dr. Valentin Cole]
scope: m2026
summary: "Lead experimental physicist aboard the UESC Marathon who headed New Cascadia's Anomaly investigative taskforce, then disappeared inside the Anomaly, leaving corrupted recordings of temporal displacement and an address to an unknown entity."
era: "Colony Era"
status: unknown
games: ["[[Marathon 2026]]"]
...
canon-status: canon
confidence: strong
tags: [character, scientist, m2026, anomaly, new-cascadia]
source-count: 12
mentioned-by: 9
appears-in: [codex]
...
**Background and expedition application.** Cole describes himself as **"Dr. Val Cole, lead experimental physicist"** applying for cryo class on the UESC Marathon; his previous project was the new Mars settlement[^5]. He characterises himself as wholly willing to accept lethal risk for the sake of discovery, expressing genuine enthusiasm for the unknowns of exoplanet colonisation and explicitly stating no concerns would stop him[^5]. Records confirm his application was accepted[^5].

**Role in New Cascadia governance.** Cole held a position of sufficient standing to be summoned to a New Cascadia council session alongside President Luca Caruso and General Davic Reed[^1]. He is addressed as "Dr. Cole" throughout that exchange[^1].

**Anomaly research leadership.** Cole led an **Anomaly investigative taskforce** whose work spanned incident reporting, DNA analysis, perimeter walks, and sample collection[^2][^3]. The incident reports filed under Cole's name are numbered sequentially from at least #38 to #56[^2]. His research collaborators named in the source are **Dr. Arjun Dasari** and **M. Stafford**; their co-authored paper is titled **"Speculations on the origins of the Anomaly"**[^6]. Cole served as on-duty supervisor during Dasari's field excursions[^2].


**Council meeting — request for taskforce resources.** In a recorded New Cascadia council session, Cole argued to President Caruso that the ground fissure (the Anomaly) was growing daily and emitting unknown radiation, and that documented effects — equipment degradation, wildlife disruption, hallucinations — were too significant to ignore[^1]. He stated a theory that the Anomaly was **linked to the novel contagion** afflicting the colony, and mentioned other abnormal phenomena that might be "beneficial if we can understand and harness the source"[^1]. Caruso denied full resources; General Reed overruled to grant ten personnel[^1].

**Subterranean-radiation theory.** The paper co-authored by Cole, Dasari, and Stafford proposes that the Anomaly's origin is **"likely below the surface of the planet, a form of terrestrial radiation caused by natural substances present on Tau Ceti IV."** It notes that attempts to study the radioactive decay were **repeatedly impeded by AI malfunction**, forcing most work to be done manually[^6].

**Taskforce extension request.** After President Caruso ordered all Anomaly taskforces disbanded, Cole sent a written communication to General Reed requesting an extension[^3]. The corrupted text reports: DNA samples show significant change across time; field excursions confirmed time appears to move differently within the Anomaly vicinity versus outside it (the closest known analogue being gravitational time dilation, but without the difference in gravitational potential)[^3]. Cole noted mandatory daily psychiatric evaluations with **Joy** were required for the entire team[^3]. He described potential benefits including accelerated food production and an effectively automatic laboratory, and the message ends with the line: **"Or we go around him"** — a reference to circumventing Caruso's authority[^3].

**Recordings made inside the Anomaly.** A heavily corrupted audio report, filed as an Audio Report during the Colony Era, captures Cole's verbal log from **inside the Anomaly site**[^4]. He reports returning at 0500, no sign of Dasari, persistent temporal abnormalities, and confusion about direction[^4]. He states: **"Time passes differently here. We were right. You hear that, Caruso? I was right."**[^4] He reports finding a body in Dasari's suit — described as **"well past advanced stages of decay"** — and a recurring perception that something is present with him[^4]. The file's dating results are described as **"incomprehensible"**[^4].
...
- **Recording 1** (topic: Self): Cole attempts first-principles grounding while inside the Anomaly. His suit biomonitor initially reads "deceased," then "indeterminate." He names his recording device **"Fermi"** (after Fermi's Paradox, for "solidarity during this paradox") and confirms he is still within the Anomaly[^8].
- **Recording 2** (topic: Memories): Fragmented first-person reminiscences — as a postdoc, as a child, as "Graduate Doctor Valentin Cole, Tharsis II Experimental Institute." His timeline is disordered; the recordings reset and loop[^9].
- **Recording 3** (topic: Anomaly): Cole offers three successive analogies for his situation inside the Anomaly: (a) a creature trapped in a reliquary; (b) a leaf caught in a bend in a drainpipe, "bound by physics"; (c) a beast and its cage. He closes: **"The Anomaly is the song. It already killed the boy."**[^10]
- **Recording 4** (topic: Freedom): Cole addresses an unknown entity in brief, fragmented statements: **"We yearned too much. Learned too little."** He then urgently shifts register — **"Wait. You're real! You're free! You can hear this — you're going to hear this! Can you understand me? You need to remember this!"**[^11]
- **Recording 5** (topic: Freedom): Cole (identifying himself as "the man is Dr. Val Cole, lead experimental physicist for a ship of dreams") tells an unknown entity they must **"understand what happened and what's still coming"** and **"find what to break and learn how to break it."** He addresses them directly as **"the thread manikin"** and closes: **"We didn't come all this way to end up like this."** The recording is described as "corrupted and influenced by an anomalous force"; one passage breaks into all-caps text attributed to an external voice[^12].

**Separate Dire Marsh Night entry.** The pack includes a volume slot for a "Cole, V. Recording" from Dire Marsh Night (`codex/world/dire-marsh-night/collectibles#h.ak1kc4890ezs`) that contains no recovered transcript — it is present as a URL entry only with no body text[^7].
...
- The "Cole, V. Recording" volume from Dire Marsh Night (`#h.ak1kc4890ezs`) contains no transcript in the pack. Whether this represents a capture gap or a truly empty/inaccessible entry is source-silent for this hub.
- The identity of the entity addressed in Recordings 4 and 5 ("thread manikin") is not named. Whether this is a Runner, a specific individual, or a generalised future audience is source-silent.
