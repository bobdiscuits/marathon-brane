...
aliases: [Thoth]
scope: trilogy
summary: "An ancient personality construct on Lh'owon, named by Durandal and activated by the Security Officer to contact the S'pht'Kr — oriented toward balance rather than victory, and later found trying, unsuccessfully, to aid the Pfhor."
era: unknown
status: extant
...
canon-status: canon
confidence: working
tags: [character, ai, trilogy, m2, thoth, trilogy-bridge]
source-count: 4
mentioned-by: 10
appears-in: [m2]
