---
type: character
aliases: [Tfear, Admiral Tfear, High Admiral Tfear, Great Admiral Tfear]
scope: trilogy
summary: "Pfhor High Admiral and Lh'owon theater commander who trapped Durandal, ordered the trih xeem deployed, and inadvertently unleashed the W'rkncacnter upon his own fleet."
era: unknown
status: unknown
games: ["[[Marathon Infinity]]", "[[Marathon 2 - Durandal]]"]
affiliation: ["[[Pfhor]]"]
canon-status: canon
confidence: strong
tags: [character, pfhor, military, trilogy, m2, infinity]
source-count: 18
mentioned-by: 8
...
**Rank and standing.** Tfear holds the title **High Admiral** (used across his own transmissions)[^1][^2] and is addressed as **Great Admiral** in his after-action report to Pfhor High Command[^3]. Durandal describes him as **"a brilliant strategist and the Pfhor's oldest active admiral,"** noting that "his list of decorations and victories would only bore you."[^4]

**Flagship.** Durandal identifies Tfear's vessel as the battleship **Khfiva**[^4]. Tycho names the same ship the **Sepfh'r**, describing it as pinning Durandal's pleasure barge "in the crushing embrace of the Sepfh'r, Admiral Tfear's own flagship."[^5] Whether Khfiva and Sepfh'r are two names for the same vessel, or whether one source is mistaken, is not resolved in the pack.

**Command authority.** Transmissions originate under the header **"Tfear High Command"** and are addressed to shipboard unit aggregates, non-glanded mercenaries, and individual conditioned units.[^6][^7][^8] He commands **Battle Group Seven**, whose **Western Arm** is destroyed in the W'rkncacnter event[^3][^4]. The Pfhor's response to the S'pht'Kr arrival puts the fleet in disarray under his overall theater command.[^9]
...
**Command conduct at Lh'owon — Envy theater.** During the Lh'owon campaign, Tfear communicates directly with the conditioned unit (the player-character). He addresses the unit as **"worm"** and describes sustained Enforcer interrogation of the unit over two weeks.[^12] He threatens immolation of surviving humans via lava flooding of a volcanic crater[^13] and directs the unit to deactivate containment fields so the humans can be captured — framing it as an offer of leniency: **"Think of it as a chance to save what little remnant of your species still lives."**[^14] He also articulates Pfhor imperial philosophy in these exchanges: **"The primary function of intelligence is the subordination of our instinctive desires, the mark of a strong species"** — and that the Commanding Rank's final purpose is to **deny selfish needs so that the Empire will survive**, serving the **Hindmost Creche**.[^15]

**Elite guards and spectation protocols.** Tfear maintains **"personal guards"** referenced by Tycho[^16] and **"elite spiral guards"** holding a relay on the Yrro station[^17]. He also issues formal spectation protocol orders governing Pfhor units wagering on the conditioned unit's fate — mandating a **43% deposit of all wagers to High Command** and executing any unit found non-compliant.[^18]
...
[^1]: [Despair — aie-mak-sicur (`^^^EOf`)](https://marathon.karnemir.com/archive/marathon/despair/aie-mak-sicur#h.svkiumbublnb) — Tfear's two terminus transmissions from dying vessel
[^2]: Multiple pack volumes using header "High Admiral Tfear"
[^3]: [Introduction — Report to Lh'owon Command](https://marathon.karnemir.com/archive/marathon/introduction#h.leywy6ta84ob) — Full after-action report to Pfhor High Command
[^4]: [Marathon 2 — Citadel — bobs-big-date (`virtus<30.4969.692.3>`)](https://marathon.karnemir.com/archive/marathon-2/citadel/bobs-big-date#h.2icj0kjleq16) — Durandal on Tfear; flagship Khfiva; Battle Group Seven
[^5]: [Rage — hang-brain (`end.burst`)](https://marathon.karnemir.com/archive/marathon/rage/hang-brain#h.t4jqs19i4qwp) — Tycho: flagship Sepfh'r; Durandal's barge captured
[^6]: [Despair — rise-robot-rise (`111.commandoversight`)](https://marathon.karnemir.com/archive/marathon/despair/rise-robot-rise#h.7pp0bsz0fn0x) — Execute R'chzne; fluids to Tycho; willful rank order
[^7]: [Despair — robot-world-arena (`111.commandoversight`)](https://marathon.karnemir.com/archive/marathon/despair/robot-world-arena#h.m6a5aoc9o26r) — Mercenaries ordered to desist
[^8]: Multiple Envy-theater transmissions origin: "High Admiral Tfear (Command)"
[^9]: [Envy — you-think-youre-big-time — `dciel1cb1`](https://marathon.karnemir.com/archive/marathon/envy/you-think-youre-big-time-youre-gonna-die-big-time#h.j97jd8ge6gd2) — S'pht'Kr arrival; W'rkncacnter in Lh'owon's sun; trih xeem pressure
[^10]: [Envy — by-committee (`seg.66.15`)](https://marathon.karnemir.com/archive/marathon/envy/by-committee#h.xi2zyuihexdo) — Durandal: Tfear most capable; 9-year containment simulation
[^11]: [Envy — you-think-youre-big-time — `wgrnc.q23`](https://marathon.karnemir.com/archive/marathon/envy/you-think-youre-big-time-youre-gonna-die-big-time#h.rpxgkdbnhqw9) — Tfear deploys trih xeem; flagship moves to Yrro station; spectation protocol
[^12]: [Envy — by-committee (`fatlin.out`)](https://marathon.karnemir.com/archive/marathon/envy/by-committee#h.agqf59ai57i7) — Tfear addresses conditioned unit; Enforcers; volcano assault
[^13]: [Envy — a-converted-church-in-venice-italy (`lin.purge`)](https://marathon.karnemir.com/archive/marathon/envy/a-converted-church-in-venice-italy#h.pph45383fl7g) — Lava flooding order; conditional assistance
[^14]: [Envy — a-converted-church-in-venice-italy (`end.run`)](https://marathon.karnemir.com/archive/marathon/envy/a-converted-church-in-venice-italy#h.9xkadrrjbnjc) — Leniency; human captive count; Gr'ndl Prime
[^15]: [Envy — one-thousand-thousand-slimy-things (`handl.remote`)](https://marathon.karnemir.com/archive/marathon/envy/one-thousand-thousand-slimy-things#h.m6kc3pws4tzc) — Imperial philosophy; Hindmost Creche; Commanding Rank
[^16]: [Envy — bagged-again (`finite.2.5`)](https://marathon.karnemir.com/archive/marathon/envy/bagged-again#h.tk4dvwoxzztj) — Tycho: Tfear's personal guards
[^17]: [Envy — aye-mak-sicur (`1023.poly.max`)](https://marathon.karnemir.com/archive/marathon/envy/aye-mak-sicur#h.mcx7tleg7yz6) — Elite spiral guards at Yrro station relay
[^18]: [Envy — you-think-youre-big-time — `tranceol`](https://marathon.karnemir.com/archive/marathon/envy/you-think-youre-big-time-youre-gonna-die-big-time#h.jspjxu2ntviu) — Spectation protocol variant
