...
aliases: [Yrro]
scope: trilogy
summary: "A figure of the S'pht creation myth who fled the W'rkncacnter with Pthia, settled Lh'owon, imprisoned the W'rkncacnter in its sun after Pthia's death, then broke the S'pht into eleven clans and abdicated to them."
era: "primordial → unknown"
status: unknown
games: ["[[Marathon Infinity]]", "[[Marathon 2 - Durandal]]"]
affiliation: ["[[S'pht]]"]
canon-status: canon
confidence: working
tags: [character, trilogy, m2, spht, myth, jjaro]
source-count: 6
mentioned-by: 9
...
**Pthia's death and Yrro's act of imprisonment.** The myth continues: *"When the W'rkncacnter came, Pthia was killed, and Yrro in anger, flung the W'rkncacnter into the sun. The sun burned them, but they swam on its surface."*[^5]
...
**Yrro's abdication.** After flinging the W'rkncacnter into the sun, Yrro *"became an angry master, bleeding for his failure, grieving for the loss of Pthia. He broke the S'pht into eleven clans, and spread them over Lh'owon."*[^5] His direct speech is recorded:

> *"I Yrro, who was your master, have failed to preserve you. Take your royalty to guide you, and live upon the paradise that you built for me."*[^5]
...
- **Mechanism of imprisonment.** The myth says Yrro *"flung"* the W'rkncacnter into the sun.[^5] The station is separately described as the instrument Yrro used to trap them.[^2] How these two accounts relate — whether the station is how the flinging was accomplished — is not resolved in the pack.
