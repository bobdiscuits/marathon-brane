...
aliases: [Felini]
scope: m2026
summary: "A class-D biosynthetic companion-pet engineered by Sekiguchi Genetics for Marathon colonists, documented with fabrication failures and anomalous rogue-unit behavior."
era: "2472 (design) -> 2808+ (Colony Era bug reports)"
status: extant
games: ["[[Marathon 2026]]"]
canon-status: canon
confidence: strong
tags: [concept, biosynth, creature, m2026, dire-marsh, sekiguchi]
source-count: 4
mentioned-by: 4
appears-in: [codex]
...
**Documented Colony Era bug reports.** An internal bug report system recorded the following active issues in deployed Felini units[^3]:
...
| --- | --- | --- |
| Felini Deliverables | Dire Marsh · Collectibles | Pre-Expedition design spec: behavioral nodes, class-D synth rules, chassis design, fur/texture challenges, kindchenschema aesthetic rationale |
| Felini Troubleshooting | Dire Marsh · Collectibles | Colony Era (Q2–Q3 2787): neural spec failure; LGRE bypass; T76 13m excavation; power output danger; inhibitor omission; hair-loss issue |
| Frequent Felini Bugs | Dire Marsh · Collectibles | Colony Era bug report system: 9 documented unit failures ranging from thermal runaway to the "doubled" unit phenomenon |
| Recording: Ghost Cat | Dire Marsh · Collectibles | Colony Era: rogue unregistered Felini with no signal, adaptive camo, anomalous door-manipulation capability; known as "ghost cat" |
